...
exports.default = {
    ...
    _getConnector: function _getConnector() {
        ...
        this.connectorPromise = this.connectorPromise.then(function () {
            var _ref5 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee5(connector) {
                var connectorOptions, noSSLBumpDomains;
                    ...
                    while (1) {
                        switch (_context5.prev = _context5.next) {
                            case 0:
                                ...
                                noSSLBumpDomains = process.env['SAUCE_NO_SSL_BUMP_DOMAINS'];


                                if (noSSLBumpDomains) connectorOptions.noSSLBumpDomains = noSSLBumpDomains.split(',');

                                connector = new _saucelabsConnector2.default(process.env['SAUCE_USERNAME'], process.env['SAUCE_ACCESS_KEY'], connectorOptions);
    ...
    openBrowser: function openBrowser(id, pageUrl, browserName) {
        ...
        return (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee10() {
            var capabilities, connector, browserOptions, tags, newBrowser, sessionUrl;
                ...
                while (1) {
                    switch (_context10.prev = _context10.next) {
                        ...
                        case 8:
                            ...
                            tags = process.env['SAUCE_TAGS'];


                            if (tags) browserOptions.tags = tags.split(',');

                            _context10.next = 13;
                            return connector.startBrowser(capabilities, pageUrl, browserOptions);
